# mlp_stock_prediction_tuned_output_matched.py
import os
import random
import numpy as np
import pandas as pd
...
y_train_pred = best_mlp.predict(X_train_2d)
y_test_pred = best_mlp.predict(X_test_2d)
...
for dataset, y_true, y_pred, label in [
    ("train", y_train_inv, y_train_pred_inv, "MLP"),
    ("test", y_test_inv, y_test_pred_inv, "MLP")
]:
